<template>
  <div class="card-simple">
      ...
      <strong class="card-simple-title" title="이동">불법 주정차 구간 데이터 불법 주정차 구간 데이터 불법 주정차 구간 데이터</strong>
      <p class="card-simple-detail">서울시에서 수집되고 있는 불법 주정차 차량 단속 이력 정보 서울시에서 수집되고 있는 불법 주정차 차량 단속 이력 정보</p>
  </div>
</template>
