          ...
          <div class="flex gap-6 items-start">
            ...
            <div class="v-group gap-5">
              ...
              <div class="search-input">
                ...
                <button class="search-input-action-button button button-neutral-ghost button-xs" type="button">
                  <span class="hidden-text">지우기</span>
                  <svg-icon class="button-icon" name="close"></svg-icon>
                </button>
              </div>
          ...
          <div class="flex gap-6 items-start">
            <div class="v-group gap-4">
              <div class="search-input">
                ...
                <button class="search-input-action-button button button-neutral-ghost button-md" type="button">
